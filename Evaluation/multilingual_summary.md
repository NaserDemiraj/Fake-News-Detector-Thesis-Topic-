...
## Method
`Evaluation/multilingual_eval.py` — a small labelled set of 10 short items: one
plausible-real and one absurd-fake statement in each of 5 languages (English, Albanian,
German, Spanish, French). Each is sent to the **deployed production backend**
(`llama-3.3-70b-versatile`, with web grounding). We measure:
...
| Language  | Lang-detect | Verdict | Notes |
|-----------|:-----------:|:-------:|-------|
| English   | 100%        | 100%    | real 90 / fake 0 |
| Albanian  | 100%        | 100%    | real 90 / fake 0 |
| German    | 100%        | 100%    | real 90 / fake 0 |
| Spanish   | 100%        | 100%    | real 90 / fake 2 |
| French    | 100%        | 100%    | real 90 / fake 0 |
| **Overall** | **100%**  | **100%**|         |

Every language was correctly identified, and in every language the plausible-real item
scored ~90 (`likely_true`) while the absurd-fake item scored 0–2 (`likely_fake`).
